...
class User extends Model {
    // declara a constante da sessao de login do usuario no painel
    const SESSION = "User";
    ...
    public static function login($login,$password) 
    {
        ...
        if (password_verify($password, $data["despassword"]) === true )
        {
            ...
            // irá passar o array todo contendo as informacoes de login
            $user->setData($data);
            //salva na sessao os valores do usuario para manter o login
    ...
    public static function getForgot($email, $inadmin = true)
    {
        ...
        if (count($results) === 0)
        {
            throw new \Exception("Nâo foi possível recuperar a senha.");
        }
        else {
            ...
            if (count($results2) === 0)
            {
                ...
                if ($inadmin === true) {
                    ...
                    $link = "http://www.php-commerce.com.br/forgot/reset?code=$code";

                } else {

                    $link = "http://www.php-commerce.com.br/admin/forgot/reset?code=$code";
